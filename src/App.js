    ...
    <div className="main">
      ...
      <div className="row board">
        <div className="col-lg-6 col-sm-12">
          <div className="item">
            <div className="item-header">Total $MIM Rewards</div>
            <div className="item-body">
              <div className="item-name">$MIM</div>
              <div className="item-value">$ { eval(parseInt(total)/1e18).toFixed(3)  }</div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 col-sm-12">
          <div className="item">
            ...
            <div className="item-body">
              <div className="item-name">$MIM</div>
              <div className="item-value">$ { eval(parseInt(userReward)/1e18).toFixed(3) }</div>
            </div>
          </div>
        </div>
        <div className="col-lg-12 col-sm-12">
          <div className="item">
            <div className="item-header">Pending $MIM Rewards</div>
            <div className="item-body">
              <div className="item-name">$MIM</div>
